...
UNS8 SlaveMap11[8] = "cycle";	/* Mapped at index 0x200A, subindex 0x00 */
INTEGER16 SlaveMap12 = 0xF0;	/* Mapped at index 0x200B, subindex 0x00 */
UNS8 SlaveMap13[8] = "require";	/* Mapped at index 0x200C, subindex 0x00 */
UNS8 SlaveMap14[520] = "CANopen is a CAN-based communication system.\n\
It comprises higher-layer protocols and profile specifications.\n\
CANopen has been developed as a standardized embedded network with highly \
flexible configuration capabilities.\n\
It was designed originally for motion-oriented machine control systems, \
such as handling systems.\n\
Today it is used in various application fields, such as medical equipment, \
off-road vehicles, maritime electronics, railway applications, \
or building automation.\n";	/* Mapped at index 0x200D, subindex 0x00 */
/**************************************************************************/
...
/* index 0x1017 :   Producer Heartbeat Time. */
		    UNS16 TestSlave_obj1017 = 0x2710;	/* 10s */
...
/* index 0x1800 :   Transmit PDO 1 Parameter. */
		    ...
		    UNS8 TestSlave_obj1800_Transmission_Type = 0xF1;	/* 0 */
...
/* index 0x1801 :   Transmit PDO 2 Parameter. */
		    ...
		    UNS8 TestSlave_obj1801_Transmission_Type = 0xA;	/* 0 */
...
/* index 0x1802 :   Transmit PDO 3 Parameter. */
		    ...
		    UNS8 TestSlave_obj1802_Transmission_Type = 0xF1;	/* 0xFF,255 event trigger*/
		    UNS16 TestSlave_obj1802_Inhibit_Time = 0x0;		/* 0x1388,5000 */
		    UNS8 TestSlave_obj1802_Compatibility_Entry = 0x0;	/* 0 */
		    UNS16 TestSlave_obj1802_Event_Timer = 0x0;		/* 0x3E8,1000 ms cycle*/
...
/* index 0x200A :   Mapped variable SlaveMap11 */
		    subindex TestSlave_Index200A[] =
		     {
		       { RW, visible_string, 6, (void*)SlaveMap11 }
		     };
...
/* index 0x200C :   Mapped variable SlaveMap13 */
		    subindex TestSlave_Index200C[] =
		     {
		       { RW, visible_string, 8, (void*)SlaveMap13 }
		     };

/* index 0x200D :   Mapped variable SlaveMap14 */
		    subindex TestSlave_Index200D[] =
		     {
		       { RW, visible_string, 512, (void*)SlaveMap14 }
		     };
 ...
 */
s_PDO_status TestSlave_PDO_status[5] = {s_PDO_status_Initializer,
